...
public class AttributesBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         TypesAttributes typesAttributes = deletableEntity.getTypesAttributes();
   ...
   private Predicate[] getSearchPredicates(Root<Attributes> root)
   {
      ...
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("type")), '%' + type.toLowerCase() + '%'));
      }
   ...
   public List<Attributes> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(Attributes.class))).getResultList();
   }
