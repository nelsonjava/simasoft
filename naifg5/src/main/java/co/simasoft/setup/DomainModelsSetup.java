...
//  ---------------------- Entities *..* Imports -------------------------
        ...
        Entities0 = findCardinalities("Muchos a Muchos Bidirecccional No.7");
        toEntities0 = findEntities("Imports");
...
//  ---------------------- Attributes *..* PropertiesAttributes -------------------------
        ...
        Attributes0 = findCardinalities("Muchos a Muchos Bidirecccional No.7");
