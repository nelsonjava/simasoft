...
//      ---------------------- Attributes:GroupIds -------------------------
    ...
    public void PropertiesAttributes(GroupIds groupIds) {
        ...
        propertiesAttributes.setName("AttributesProperties");
...
/*
        TypesAttributes typeslink1 = new TypesAttributes();
        typeslink1 = findTypesAttributes("String");

        Attributes link1 = new Attributes();
        link1.setName("link");
        link1.setNullable(true);
        link1.setSingle(false);
        link1.setTypesAttributes(typeslink1);
        link1.setEntities(propertiesAttributes);
        em.persist(link1);
        em.flush();
*/        
...
//      ---------------------- Attributes:NameQueries -------------------------
    ...
    public void TypesAttributes(GroupIds groupIds) {
        ...
        typesAttributes.setName("AttributesTypes");
