...
public class Entities implements Serializable {
	...
	public Entities(String name, String serialID, String description,
			String observations, String annotations, String source,
			String modifier, String extend, String table, String tableSecuencia) {
		this.name = name;
