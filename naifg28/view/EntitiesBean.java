        ...
        public String delete() {
          ...
          for (; iterTo.hasNext();){
             ...
             this.entityManager.merge(nextInTo);
                        ...
                        Iterator<AttributesProperties> iterAttributesProperties = deletableEntity.getAttributesProperties().iterator();
                        for (; iterAttributesProperties.hasNext();){
                               AttributesProperties nextInAttributesProperties = iterAttributesProperties.next();
                                nextInAttributesProperties.setEntities(null);
