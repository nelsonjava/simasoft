...
public class Companies implements Serializable {
	...
	private Set<Funds> funds = new HashSet<Funds>();
	...
	private Set<Companies> objHijos = new HashSet<Companies>();

	@ManyToOne
	private Companies objPadre;
	...
	public Set<Companies> getObjHijos() {
		return this.objHijos;
	}
	public void setObjHijos(Set<Companies> objHijos) {
		this.objHijos = objHijos;
	}

	public Companies getObjPadre() {
		return this.objPadre;
	}
	public void setObjPadre(Companies objPadre) {
