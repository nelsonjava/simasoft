...
@Entity
@XmlRootElement
public class ImprovementSources implements Serializable {
	...
	@OneToMany(mappedBy = "improvementSources")
	private Set<ContinualImprovements> continualImprovements = new HashSet<ContinualImprovements>();

	public ImprovementSources() {
	}

	public ImprovementSources(String name) {
		this.name = name;
	}
	...
	public boolean equals(Object ojt) {
		...
		ImprovementSources other = (ImprovementSources) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
