...
@Entity
@XmlRootElement
public class SeriesReports implements Serializable {
	...
	@OneToMany(mappedBy = "seriesReports")
	private Set<Reports> reports = new HashSet<Reports>();

	@ManyToOne
	private SectionsReports sectionsReports;

	public SeriesReports() {
	}

	public SeriesReports(String name, String code) {
		this.name = name;
		this.code = code;
	}
	...
	public boolean equals(Object ojt) {
		...
		SeriesReports other = (SeriesReports) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
