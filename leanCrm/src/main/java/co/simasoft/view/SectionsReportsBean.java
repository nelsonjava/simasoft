...
/**
 * Backing bean for SectionsReports entities.
 * <p/>
 * This class provides CRUD functionality for all SectionsReports entities. It
...
public class SectionsReportsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<SeriesReports> iterSeriesReports = deletableEntity
					.getSeriesReports().iterator();
	...
	public void paginate() {
		...
		CriteriaQuery<SectionsReports> criteria = builder
				.createQuery(SectionsReports.class);
		root = criteria.from(SectionsReports.class);
		TypedQuery<SectionsReports> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back SectionsReports entities (e.g. from
	 * inside an HtmlSelectOneMenu)
	 */

	public List<SectionsReports> getAll() {

		CriteriaQuery<SectionsReports> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(SectionsReports.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(SectionsReports.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final SectionsReportsBean ejbProxy = this.sessionContext
				.getBusinessObject(SectionsReportsBean.class);
