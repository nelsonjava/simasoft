...
/**
 * Backing bean for BooksTypes entities.
 * <p/>
 * This class provides CRUD functionality for all BooksTypes entities. It
...
public class BooksTypesBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<BooksTypes> iterObjHijos = deletableEntity.getObjHijos()
					.iterator();
			...
			BooksTypes objPadre = deletableEntity.getObjPadre();
	...
	public void paginate() {
		...
		CriteriaQuery<BooksTypes> criteria = builder
				.createQuery(BooksTypes.class);
		root = criteria.from(BooksTypes.class);
		TypedQuery<BooksTypes> query = this.entityManager.createQuery(criteria
	...
	private Predicate[] getSearchPredicates(Root<BooksTypes> root) {
		...
		BooksTypes objPadre = this.example.getObjPadre();
		if (objPadre != null) {
	...
	/*
	 * Support listing and POSTing back BooksTypes entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<BooksTypes> getAll() {

		CriteriaQuery<BooksTypes> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(BooksTypes.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(BooksTypes.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final BooksTypesBean ejbProxy = this.sessionContext
				.getBusinessObject(BooksTypesBean.class);
