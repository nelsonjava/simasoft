...
/**
 * Backing bean for ImprovementVerifications entities.
 * <p/>
 * This class provides CRUD functionality for all ImprovementVerifications
...
public class ImprovementVerificationsBean implements Serializable {
	...
	public void setImprovementVerifications(
			ImprovementVerifications improvementVerifications) {
		...
		try {
			if (this.id == null) {
				...
				return "view?faces-redirect=true&id="
						+ this.improvementVerifications.getId();
			}
		} catch (Exception e) {
	...
	public void paginate() {
		...
		Root<ImprovementVerifications> root = countCriteria
				.from(ImprovementVerifications.class);
		...
		CriteriaQuery<ImprovementVerifications> criteria = builder
				.createQuery(ImprovementVerifications.class);
		root = criteria.from(ImprovementVerifications.class);
		TypedQuery<ImprovementVerifications> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back ImprovementVerifications entities (e.g.
	 * from inside an HtmlSelectOneMenu)
	 */

	public List<ImprovementVerifications> getAll() {

		CriteriaQuery<ImprovementVerifications> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(
						ImprovementVerifications.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(ImprovementVerifications.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final ImprovementVerificationsBean ejbProxy = this.sessionContext
				.getBusinessObject(ImprovementVerificationsBean.class);
		...
		return new Converter() {
			...
			public String getAsString(FacesContext context,
				...
				return String.valueOf(((ImprovementVerifications) value)
						.getId());
			}
		};
	}
