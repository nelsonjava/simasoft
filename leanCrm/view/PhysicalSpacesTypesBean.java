...
public class PhysicalSpacesTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.physicalSpacesTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
          ...
          Iterator<PhysicalSpacesTypes> iterObjHijos = deletableEntity.getObjHijos().iterator();
   ...
   1      PhysicalSpacesTypes objPadre = deletableEntity.getObjPadre();
   ...
   1      this.entityManager.merge(objPadre);
        ...
        public void paginate() {
                ...
                Root<PhysicalSpacesTypes> root = countCriteria.from(PhysicalSpacesTypes.class);
                ...
                CriteriaQuery<PhysicalSpacesTypes> criteria = builder.createQuery(PhysicalSpacesTypes.class);
                root = criteria.from(PhysicalSpacesTypes.class);
                TypedQuery<PhysicalSpacesTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back PhysicalSpacesTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<PhysicalSpacesTypes> getAll() {
                CriteriaQuery<PhysicalSpacesTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(PhysicalSpacesTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(PhysicalSpacesTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final PhysicalSpacesTypesBean ejbProxy = this.sessionContext.getBusinessObject(PhysicalSpacesTypesBean.class);
