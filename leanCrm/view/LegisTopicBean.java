...
public class LegisTopicBean implements Serializable {
        ...
        public String delete() {
                ...
                try {
                        ...
                        LegisTopicTypes legisTopicTypes = deletableEntity.getLegisTopicTypes();
        ...
        public void paginate() {
                ...
                CriteriaQuery<LegisTopic> criteria = builder.createQuery(LegisTopic.class);
                root = criteria.from(LegisTopic.class);
                TypedQuery<LegisTopic> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back LegisTopic entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<LegisTopic> getAll() {
                CriteriaQuery<LegisTopic> criteria = this.entityManager.getCriteriaBuilder().createQuery(LegisTopic.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(LegisTopic.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final LegisTopicBean ejbProxy = this.sessionContext.getBusinessObject(LegisTopicBean.class);
