...
public class ActivitiesTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.activitiesTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<ActivitiesTypes> criteria = builder.createQuery(ActivitiesTypes.class);
                root = criteria.from(ActivitiesTypes.class);
                TypedQuery<ActivitiesTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ActivitiesTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ActivitiesTypes> getAll() {
                CriteriaQuery<ActivitiesTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(ActivitiesTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ActivitiesTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ActivitiesTypesBean ejbProxy = this.sessionContext.getBusinessObject(ActivitiesTypesBean.class);
