...
public class LegisArtBean implements Serializable {
        ...
        public void paginate() {
                ...
                TypedQuery<LegisArt> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back LegisArt entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<LegisArt> getAll() {
                CriteriaQuery<LegisArt> criteria = this.entityManager.getCriteriaBuilder().createQuery(LegisArt.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(LegisArt.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final LegisArtBean ejbProxy = this.sessionContext.getBusinessObject(LegisArtBean.class);
