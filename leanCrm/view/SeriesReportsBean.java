...
public class SeriesReportsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.seriesReports.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<Reports> iterReports = deletableEntity.getReports().iterator();
                        ...
                        SectionsReports sectionsReports = deletableEntity.getSectionsReports();
        ...
        public void paginate() {
                ...
                CriteriaQuery<SeriesReports> criteria = builder.createQuery(SeriesReports.class);
                root = criteria.from(SeriesReports.class);
                TypedQuery<SeriesReports> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back SeriesReports entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<SeriesReports> getAll() {
                CriteriaQuery<SeriesReports> criteria = this.entityManager.getCriteriaBuilder().createQuery(SeriesReports.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(SeriesReports.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final SeriesReportsBean ejbProxy = this.sessionContext.getBusinessObject(SeriesReportsBean.class);
