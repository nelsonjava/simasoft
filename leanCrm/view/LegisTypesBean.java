...
public class LegisTypesBean implements Serializable {
        ...
        public void paginate() {
                ...
                CriteriaQuery<LegisTypes> criteria = builder.createQuery(LegisTypes.class);
                root = criteria.from(LegisTypes.class);
                TypedQuery<LegisTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back LegisTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<LegisTypes> getAll() {
                CriteriaQuery<LegisTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(LegisTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(LegisTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final LegisTypesBean ejbProxy = this.sessionContext.getBusinessObject(LegisTypesBean.class);
