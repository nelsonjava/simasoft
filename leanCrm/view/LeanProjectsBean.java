...
public class LeanProjectsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.leanProjects.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<ModelsCanvas> iterModelsCanvas = deletableEntity.getModelsCanvas().iterator();
        ...
        public void paginate() {
                ...
                CriteriaQuery<LeanProjects> criteria = builder.createQuery(LeanProjects.class);
                root = criteria.from(LeanProjects.class);
                TypedQuery<LeanProjects> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back LeanProjects entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<LeanProjects> getAll() {
                CriteriaQuery<LeanProjects> criteria = this.entityManager.getCriteriaBuilder().createQuery(LeanProjects.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(LeanProjects.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final LeanProjectsBean ejbProxy = this.sessionContext.getBusinessObject(LeanProjectsBean.class);
