...
public class FinalDispositionBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.finalDisposition.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<FinalDisposition> root = countCriteria.from(FinalDisposition.class);
                ...
                CriteriaQuery<FinalDisposition> criteria = builder.createQuery(FinalDisposition.class);
                root = criteria.from(FinalDisposition.class);
                TypedQuery<FinalDisposition> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back FinalDisposition entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<FinalDisposition> getAll() {
                CriteriaQuery<FinalDisposition> criteria = this.entityManager.getCriteriaBuilder().createQuery(FinalDisposition.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(FinalDisposition.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final FinalDispositionBean ejbProxy = this.sessionContext.getBusinessObject(FinalDispositionBean.class);
