...
@Entity
@XmlRootElement
public class SwitchesPorts implements Serializable {
	...
	@OneToMany(mappedBy = "switchesPorts")
	...
	public SwitchesPorts() {
	}

	public SwitchesPorts(String port, String code, String state, Integer mts) {
		this.port = port;
		this.code = code;
		this.state = state;
		this.mts = mts;
	...
	public boolean equals(Object ojt) {
		...
		SwitchesPorts other = (SwitchesPorts) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
