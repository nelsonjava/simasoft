...
@Entity
@XmlRootElement
public class NetworkPorts implements Serializable {
	...
	public NetworkPorts(String ipAddress, String macAddress, String state) {
	...
	public boolean equals(Object ojt) {
		...
		NetworkPorts other = (NetworkPorts) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
