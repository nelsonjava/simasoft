...
import co.simasoft.models.IdsTypes;
import co.simasoft.models.Ids;
import java.util.Iterator;

/**
 * Backing bean for IdsTypes entities.
 * <p/>
 * This class provides CRUD functionality for all IdsTypes entities. It focuses
...
public class IdsTypesBean implements Serializable {
	...
	public void paginate() {
		...
		TypedQuery<IdsTypes> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back IdsTypes entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<IdsTypes> getAll() {

		CriteriaQuery<IdsTypes> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(IdsTypes.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(IdsTypes.class))).getResultList();
	}
	...
	public Converter getConverter() {
		...
		final IdsTypesBean ejbProxy = this.sessionContext
				.getBusinessObject(IdsTypesBean.class);
