...
public class EmployeesBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<PositionsCompany> iterPositionsCompany = deletableEntity
					.getPositionsCompany().iterator();
			for (; iterPositionsCompany.hasNext();) {
				PositionsCompany nextInPositionsCompany = iterPositionsCompany
						.next();
	...
	private Predicate[] getSearchPredicates(Root<Employees> root) {
		...
		EmployeesTypes employeesTypes = this.example.getEmployeesTypes();
