...
/**
 * Backing bean for EmployeesTypes entities.
 * <p/>
 * This class provides CRUD functionality for all EmployeesTypes entities. It
...
public class EmployeesTypesBean implements Serializable {
	...
	public void paginate() {
		...
		CriteriaQuery<EmployeesTypes> criteria = builder
				.createQuery(EmployeesTypes.class);
		root = criteria.from(EmployeesTypes.class);
		TypedQuery<EmployeesTypes> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back EmployeesTypes entities (e.g. from
	 * inside an HtmlSelectOneMenu)
	 */

	public List<EmployeesTypes> getAll() {

		CriteriaQuery<EmployeesTypes> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(EmployeesTypes.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(EmployeesTypes.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final EmployeesTypesBean ejbProxy = this.sessionContext
				.getBusinessObject(EmployeesTypesBean.class);
