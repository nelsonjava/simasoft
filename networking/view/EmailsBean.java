...
public class EmailsBean implements Serializable {
        ...
        public void paginate() {
                ...
                TypedQuery<Emails> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Emails entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Emails> getAll() {
                CriteriaQuery<Emails> criteria = this.entityManager.getCriteriaBuilder().createQuery(Emails.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Emails.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final EmailsBean ejbProxy = this.sessionContext.getBusinessObject(EmailsBean.class);
