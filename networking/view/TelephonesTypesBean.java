...
public class TelephonesTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.telephonesTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<TelephonesTypes> criteria = builder.createQuery(TelephonesTypes.class);
                root = criteria.from(TelephonesTypes.class);
                TypedQuery<TelephonesTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back TelephonesTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<TelephonesTypes> getAll() {
                CriteriaQuery<TelephonesTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(TelephonesTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(TelephonesTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final TelephonesTypesBean ejbProxy = this.sessionContext.getBusinessObject(TelephonesTypesBean.class);
