...
public class PositionsCompanyBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.positionsCompany.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<PositionsCompany> root = countCriteria.from(PositionsCompany.class);
                ...
                CriteriaQuery<PositionsCompany> criteria = builder.createQuery(PositionsCompany.class);
                root = criteria.from(PositionsCompany.class);
                TypedQuery<PositionsCompany> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back PositionsCompany entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<PositionsCompany> getAll() {
                CriteriaQuery<PositionsCompany> criteria = this.entityManager.getCriteriaBuilder().createQuery(PositionsCompany.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(PositionsCompany.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final PositionsCompanyBean ejbProxy = this.sessionContext.getBusinessObject(PositionsCompanyBean.class);
