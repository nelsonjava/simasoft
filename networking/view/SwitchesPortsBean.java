...
public class SwitchesPortsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.switchesPorts.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<SwitchesPorts> criteria = builder.createQuery(SwitchesPorts.class);
                root = criteria.from(SwitchesPorts.class);
                TypedQuery<SwitchesPorts> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back SwitchesPorts entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<SwitchesPorts> getAll() {
                CriteriaQuery<SwitchesPorts> criteria = this.entityManager.getCriteriaBuilder().createQuery(SwitchesPorts.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(SwitchesPorts.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final SwitchesPortsBean ejbProxy = this.sessionContext.getBusinessObject(SwitchesPortsBean.class);
