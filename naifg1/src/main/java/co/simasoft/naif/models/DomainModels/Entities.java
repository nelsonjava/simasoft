...
public class Entities implements Serializable {
	...
	@ManyToOne
	private Packages packagess;

	public Entities() {
	}

	public Entities(String tablaSecuencia, String imports, String serialID,
			String source, String description, String extend,
			String annotations, String modifier, String tabla,
			String observaciones, String name) {
	...
	public void setPackagess(Packages packagess) {
