...
public class Entities {
	...
	public Entities(String name, String tabla, String tablaSecuencia,
			String modifier, String extend, String imports, String annotations,
			String source, String description, String observaciones) {
		this.name = name;
		this.tabla = tabla;
