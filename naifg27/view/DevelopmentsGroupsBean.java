        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        DevelopmentsGroups developmentsGroups = deletableEntity.getDevelopmentsGroups();
                        developmentsGroups.getDevelopmentsGroups().remove(deletableEntity);
                        deletableEntity.setDevelopmentsGroups(null);
                        this.entityManager.merge(developmentsGroups);
                        DevelopmentsGroups developmentsGroups = deletableEntity.getDevelopmentsGroups();
                        developmentsGroups.getDevelopmentsGroups().remove(deletableEntity);
                        deletableEntity.setDevelopmentsGroups(null);
                        this.entityManager.merge(developmentsGroups);
