        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        ModelRelationships modelRelationships = deletableEntity.getModelRelationships();
                        modelRelationships.getModelRelationships().remove(deletableEntity);
                        deletableEntity.setModelRelationships(null);
                        this.entityManager.merge(modelRelationships);
                        ModelRelationships modelRelationships = deletableEntity.getModelRelationships();
                        modelRelationships.getModelRelationships().remove(deletableEntity);
                        deletableEntity.setModelRelationships(null);
                        this.entityManager.merge(modelRelationships);
