        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        attributes.getAttributes().remove(deletableEntity);
        ...
        public void paginate() {
                ...
                CriteriaQuery<Attributes> criteria = builder.createQuery(Attributes.class);
                root = criteria.from(Attributes.class);
                TypedQuery<Attributes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Attributes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Attributes> getAll() {
                CriteriaQuery<Attributes> criteria = this.entityManager.getCriteriaBuilder().createQuery(Attributes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Attributes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final AttributesBean ejbProxy = this.sessionContext.getBusinessObject(AttributesBean.class);
