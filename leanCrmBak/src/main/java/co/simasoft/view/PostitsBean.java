...
public class PostitsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			ModelsCanvasSections modelsCanvasSections = deletableEntity
					.getModelsCanvasSections();
			modelsCanvasSections.getPostits().remove(deletableEntity);
			deletableEntity.setModelsCanvasSections(null);
			this.entityManager.merge(modelsCanvasSections);
	...
	private Predicate[] getSearchPredicates(Root<Postits> root) {
		...
		ModelsCanvasSections modelsCanvasSections = this.example
				.getModelsCanvasSections();
		if (modelsCanvasSections != null) {
			predicatesList.add(builder.equal(root.get("modelsCanvasSections"),
