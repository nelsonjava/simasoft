...
/**
 * Backing bean for ItemsStates entities.
 * <p/>
 * This class provides CRUD functionality for all ItemsStates entities. It
...
public class ItemsStatesBean implements Serializable {
	...
	public void paginate() {
		...
		CriteriaQuery<ItemsStates> criteria = builder
				.createQuery(ItemsStates.class);
		root = criteria.from(ItemsStates.class);
		TypedQuery<ItemsStates> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back ItemsStates entities (e.g. from inside
	 * an HtmlSelectOneMenu)
	 */

	public List<ItemsStates> getAll() {

		CriteriaQuery<ItemsStates> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(ItemsStates.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(ItemsStates.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final ItemsStatesBean ejbProxy = this.sessionContext
				.getBusinessObject(ItemsStatesBean.class);
