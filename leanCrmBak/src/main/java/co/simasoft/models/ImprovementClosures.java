...
@Entity
@XmlRootElement
public class ImprovementClosures implements Serializable {
	...
	@OneToMany(mappedBy = "improvementClosures")
	private Set<ClosingActivities> closingActivities = new HashSet<ClosingActivities>();

	@OneToMany(mappedBy = "improvementClosures")
	private Set<ContinualImprovements> continualImprovements = new HashSet<ContinualImprovements>();

	public ImprovementClosures() {
	}

	public ImprovementClosures(Date dateClosing) {
	...
	public Set<ClosingActivities> getClosingActivities() {
		return closingActivities;
	}
	public void setClosingActivities(Set<ClosingActivities> closingActivities) {
	...
	public boolean equals(Object ojt) {
		...
		ImprovementClosures other = (ImprovementClosures) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
