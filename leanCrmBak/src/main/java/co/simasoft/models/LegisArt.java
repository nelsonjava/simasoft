...
@Entity
@XmlRootElement
public class LegisArt implements Serializable {
	...
	public LegisArt(String code, String name, String content) {
		this.code = code;
		this.name = name;
