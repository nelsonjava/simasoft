...
@Entity
@XmlRootElement
public class ImprovementTypes implements Serializable {
	...
	@OneToMany(mappedBy = "improvementTypes")
	private Set<ContinualImprovements> continualImprovements = new HashSet<ContinualImprovements>();

	public ImprovementTypes() {
	}

	public ImprovementTypes(String name) {
		this.name = name;
	}
	...
	public boolean equals(Object ojt) {
		...
		ImprovementTypes other = (ImprovementTypes) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
