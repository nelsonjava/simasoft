...
public class ModelsCanvasBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.modelsCanvas.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<ModelsCanvas> criteria = builder.createQuery(ModelsCanvas.class);
                root = criteria.from(ModelsCanvas.class);
                TypedQuery<ModelsCanvas> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ModelsCanvas entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ModelsCanvas> getAll() {
                CriteriaQuery<ModelsCanvas> criteria = this.entityManager.getCriteriaBuilder().createQuery(ModelsCanvas.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ModelsCanvas.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ModelsCanvasBean ejbProxy = this.sessionContext.getBusinessObject(ModelsCanvasBean.class);
