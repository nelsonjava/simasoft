...
public class PostitsBean implements Serializable {
        ...
        public String delete() {
          ...
          Iterator<Postits> iterObjHijos = deletableEntity.getObjHijos().iterator();
          for (; iterObjHijos.hasNext();){
             ...
             this.entityManager.merge(nextInObjHijos);
                        ...
                        ModelsCanvasSections modelsCanvasSections = deletableEntity.getModelsCanvasSections();
   ...
   1      Postits objPadre = deletableEntity.getObjPadre();
