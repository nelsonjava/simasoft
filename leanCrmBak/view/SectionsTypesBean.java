...
public class SectionsTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.sectionsTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<SectionsTypes> criteria = builder.createQuery(SectionsTypes.class);
                root = criteria.from(SectionsTypes.class);
                TypedQuery<SectionsTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back SectionsTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<SectionsTypes> getAll() {
                CriteriaQuery<SectionsTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(SectionsTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(SectionsTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final SectionsTypesBean ejbProxy = this.sessionContext.getBusinessObject(SectionsTypesBean.class);
