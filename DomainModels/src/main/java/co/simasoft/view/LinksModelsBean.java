...
public class LinksModelsBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.linksModels.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         TiposLinksModels tiposLinksModels = deletableEntity.getTiposLinksModels();
   ...
   public void paginate()
   {
      ...
      CriteriaQuery<LinksModels> criteria = builder.createQuery(LinksModels.class);
   ...
   private Predicate[] getSearchPredicates(Root<LinksModels> root)
   {
      ...
      {
         predicatesList.add(builder.equal(root.get("domainModels"), domainModels));
      }
      TiposLinksModels tiposLinksModels = this.example.getTiposLinksModels();
      if (tiposLinksModels != null)
      {
         predicatesList.add(builder.equal(root.get("tiposLinksModels"), tiposLinksModels));
      }
   ...
   public List<LinksModels> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(LinksModels.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      final LinksModelsBean ejbProxy = this.sessionContext.getBusinessObject(LinksModelsBean.class);
