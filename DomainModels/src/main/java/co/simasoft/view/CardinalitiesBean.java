...
public class CardinalitiesBean implements Serializable
{
   ...
   public void paginate()
   {
      ...
      TypedQuery<Cardinalities> query = this.entityManager.createQuery(criteria
   ...
   private Predicate[] getSearchPredicates(Root<Cardinalities> root)
   {
      ...
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("cardinality")), '%' + cardinality.toLowerCase() + '%'));
      }
   ...
   public List<Cardinalities> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(Cardinalities.class))).getResultList();
   }
