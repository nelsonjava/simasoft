...
import co.simasoft.dbf.file.*;

/**
 * Utility to read a DBF File, and produce an object
 * representation of all its content.
 */
public final class DBFReader {
	
	/** Dbf source file encoding. */
	private static final String DBF_CHARSET = "IBM850";
	...
	private void readDBFFieldsRecords() throws IOException {
		...
		for (DBFFieldDescriptor column : dbfFile.getFieldDescs()) {
			...
			String value 	= new String(cell, DBF_CHARSET).trim();
