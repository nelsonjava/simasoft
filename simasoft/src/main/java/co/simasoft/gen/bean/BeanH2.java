...
line("                        FacesContext.getCurrentInstance().addMessage(null,");
line("                                        new FacesMessage(e.getMessage()));");
line("                        return null;");
line("                }");
line("        }\n");
...
line("                countCriteria = countCriteria.select(builder.count(root)).where(");
line("                                getSearchPredicates(root));");
