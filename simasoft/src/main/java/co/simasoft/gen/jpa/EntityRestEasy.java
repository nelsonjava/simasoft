...
public class EntityRestEasy extends FileTxt {
...
public EntityRestEasy(String artifactId,String groupId,Entidad entity,LinkedHashSet<String> imports) throws IOException {
