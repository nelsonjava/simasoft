   ...
   public String delete()
   {
      ...
      try
      {
         ...
         for (; iterOpciones.hasNext();)
         {
            ...
            nextInOpciones.setPermisos(null);
            iterOpciones.remove();
