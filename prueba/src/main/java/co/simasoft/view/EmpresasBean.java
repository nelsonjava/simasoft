...
import co.simasoft.models.pruebas.prueba.Empresas;
import co.simasoft.models.pruebas.prueba.Datos;
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         for (; iterUsuariosEmps.hasNext();)
         {
            ...
            nextInUsuariosEmps.setEmpresas(null);
