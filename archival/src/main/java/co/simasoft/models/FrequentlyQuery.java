...
@Entity
@XmlRootElement
public class FrequentlyQuery implements Serializable {
    ...
    @OneToMany(mappedBy = "frequentlyQuery")
    private Set<DocumentalsUnits> documentalsUnits = new HashSet<DocumentalsUnits>();

    public FrequentlyQuery() {
    }

    public FrequentlyQuery(Integer name) {
        this.name = name;
    }
   ...
   public boolean equals(Object ojt) {
      ...
      FrequentlyQuery other = (FrequentlyQuery) ojt;
      if (id == null) {
         if (other.id != null) {
            return false;
         }
