...
@Entity
@XmlRootElement
public class DocumentalsUnitsTypes implements Serializable {
	...
	@OneToMany(mappedBy = "documentalsUnitsTypes")
	private Set<DocumentalsUnits> documentalsUnits = new HashSet<DocumentalsUnits>();

	public DocumentalsUnitsTypes() {
	}

	public DocumentalsUnitsTypes(String name) {
		this.name = name;
	}
	...
	public boolean equals(Object ojt) {
		...
		DocumentalsUnitsTypes other = (DocumentalsUnitsTypes) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
