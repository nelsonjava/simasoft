...
/**
 * Backing bean for VersionsControls entities.
 * <p/>
 * This class provides CRUD functionality for all VersionsControls entities. It
...
public class VersionsControlsBean implements Serializable {
	...
	public void paginate() {
		...
		Root<VersionsControls> root = countCriteria
				.from(VersionsControls.class);
		...
		CriteriaQuery<VersionsControls> criteria = builder
				.createQuery(VersionsControls.class);
		root = criteria.from(VersionsControls.class);
		TypedQuery<VersionsControls> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back VersionsControls entities (e.g. from
	 * inside an HtmlSelectOneMenu)
	 */

	public List<VersionsControls> getAll() {

		CriteriaQuery<VersionsControls> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(VersionsControls.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(VersionsControls.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final VersionsControlsBean ejbProxy = this.sessionContext
				.getBusinessObject(VersionsControlsBean.class);
