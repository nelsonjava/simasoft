...
public class SectionsBean implements Serializable {
        ...
        public String delete() {
          ...
          Iterator<Sections> iterObjHijos = deletableEntity.getObjHijos().iterator();
          for (; iterObjHijos.hasNext();){
             ...
             this.entityManager.merge(nextInObjHijos);
                        ...
                        Iterator<Series> iterSeries = deletableEntity.getSeries().iterator();
                        for (; iterSeries.hasNext();){
                               Series nextInSeries = iterSeries.next();
                                nextInSeries.setSections(null);
                               iterSeries.remove();
   ...
   1      Sections objPadre = deletableEntity.getObjPadre();
