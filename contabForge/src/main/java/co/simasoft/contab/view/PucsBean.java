...
/**
 * Backing bean for Pucs entities.
 * <p/>
 * This class provides CRUD functionality for all Pucs entities. It focuses
...
public class PucsBean implements Serializable
{
   ...
   public void paginate()
   {
      ...
      TypedQuery<Pucs> query = this.entityManager.createQuery(criteria
   ...
   private Predicate[] getSearchPredicates(Root<Pucs> root)
   {
      ...
      Pucs objPadre = this.example.getObjPadre();
      if (objPadre != null)
      {
   ...
   /*
    * Support listing and POSTing back Pucs entities (e.g. from inside an
    * HtmlSelectOneMenu)
    */
   ...
   public List<Pucs> getAll()
   {
      ...
      CriteriaQuery<Pucs> criteria = this.entityManager
            .getCriteriaBuilder().createQuery(Pucs.class);
      return this.entityManager.createQuery(
            criteria.select(criteria.from(Pucs.class))).getResultList();
   }
