...
@Indexed
@Entity
public class SoporteDocumental implements Serializable {
	...
	@ManyToMany(mappedBy = "soporteDocumental")
	private Set<UnidadesDocumentales> unidadesDocumentales = new HashSet<UnidadesDocumentales>();

	public SoporteDocumental() {
	}

	public SoporteDocumental(String nombre) {
		this.nombre = nombre;
	}
	...
	public boolean equals(Object ojt) {
		...
		SoporteDocumental other = (SoporteDocumental) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
