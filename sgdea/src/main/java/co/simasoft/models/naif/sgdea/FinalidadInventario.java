...
@Indexed
@Entity
public class FinalidadInventario implements Serializable {
	...
	@OneToMany(mappedBy = "finalidadInventario")
	private Set<InventarioDocumental> inventarioDocumental = new HashSet<InventarioDocumental>();

	public FinalidadInventario() {
	}

	public FinalidadInventario(String nombre) {
		this.nombre = nombre;
	}
	...
	public boolean equals(Object ojt) {
		...
		FinalidadInventario other = (FinalidadInventario) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
