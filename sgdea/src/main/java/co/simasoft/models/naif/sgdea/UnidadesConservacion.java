...
@Indexed
@Entity
public class UnidadesConservacion implements Serializable {
	...
	@OneToMany(mappedBy = "unidadesConservacion")
	private Set<UnidadesDocumentales> unidadesDocumentales = new HashSet<UnidadesDocumentales>();

	public UnidadesConservacion() {
	}

	public UnidadesConservacion(String nombre) {
		this.nombre = nombre;
	}
	...
	public boolean equals(Object ojt) {
		...
		UnidadesConservacion other = (UnidadesConservacion) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
