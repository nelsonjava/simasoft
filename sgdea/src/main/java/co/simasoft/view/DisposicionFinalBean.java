...
public class DisposicionFinalBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			for (; iterTrd.hasNext();) {
				...
				nextInTrd.setDisposicionFinal(null);
				iterTrd.remove();
	...
	public void paginate() {
		...
		Root<DisposicionFinal> root = countCriteria
				.from(DisposicionFinal.class);
		...
		CriteriaQuery<DisposicionFinal> criteria = builder
				.createQuery(DisposicionFinal.class);
		root = criteria.from(DisposicionFinal.class);
		TypedQuery<DisposicionFinal> query = this.entityManager
	...
	public List<DisposicionFinal> getAll() {
		...
		return this.entityManager.createQuery(
				criteria.select(criteria.from(DisposicionFinal.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final DisposicionFinalBean ejbProxy = this.sessionContext
				.getBusinessObject(DisposicionFinalBean.class);
