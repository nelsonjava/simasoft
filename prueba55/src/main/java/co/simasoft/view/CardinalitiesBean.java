 ...
 * <p/>
 * This class provides CRUD functionality for all Cardinalities entities. It
...
public class CardinalitiesBean implements Serializable {
	...
	@PersistenceContext(unitName = "prueba55PU-JTA", type = PersistenceContextType.EXTENDED)
	...
	public String delete() {
		...
		try {
			...
			Iterator<Cardinalities> iterObjHijos = deletableEntity
	...
	private Predicate[] getSearchPredicates(Root<Cardinalities> root) {
		...
		Cardinalities objPadre = this.example.getObjPadre();
		if (objPadre != null) {
	...
	/*
	 * Support listing and POSTing back Cardinalities entities (e.g. from inside
