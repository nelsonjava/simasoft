...
public class Attributes implements Serializable {
	...
	public Attributes(Boolean isCreate, Boolean isSearch, Boolean isView,
			Boolean isViewColumn, Boolean isViewRelation, String name,
			String description, Integer length, Integer precision,
			Boolean isNullable, Boolean isUnique, Boolean isSimplified) {
