...
/**
 * Backing bean for Groups entities.
 * <p/>
 * This class provides CRUD functionality for all Groups entities. It focuses
...
public class GroupsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<GroupsModels> iterGroupsModels = deletableEntity
					.getGroupsModels().iterator();
			...
			Iterator<DevelopmentsGroups> iterDevelopmentsGroups = deletableEntity
					.getDevelopmentsGroups().iterator();
			for (; iterDevelopmentsGroups.hasNext();) {
				DevelopmentsGroups nextInDevelopmentsGroups = iterDevelopmentsGroups
						.next();
	...
	public void paginate() {
		...
		TypedQuery<Groups> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back Groups entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<Groups> getAll() {

		CriteriaQuery<Groups> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(Groups.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(Groups.class))).getResultList();
	}
	...
	public Converter getConverter() {
		...
		final GroupsBean ejbProxy = this.sessionContext
				.getBusinessObject(GroupsBean.class);
