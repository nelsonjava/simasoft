package com.naif.facturacion.customnodes.calendar;
...
public class DatePicker extends HBox {
    ...
    public DatePicker(Locale locale) {
        ...
        calendarView.todayButtonTextProperty().set("Elegir hoy");
        // Use the same locale.
    ...
    private void updateTextField() {
        ...
        if (selectedDateProperty().get() != null) {
            ...
            if (!textField.getText().equals(date)) {
                textField.setText(date.toUpperCase());
            }
        } else {
            textField.setText("");
        }
    ...
    public double getDPrefWidth() {
    	return textField.getPrefWidth();
    }
    
    public void setDPrefWidth(double width) {
