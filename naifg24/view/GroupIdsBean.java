        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<GroupIdsEntities> iterGroupIdsEntities = deletableEntity.getGroupIdsEntities().iterator();
                        for (; iterGroupIdsEntities.hasNext();){
                               GroupIdsEntities nextInGroupIdsEntities = iterGroupIdsEntities.next();
                                nextInGroupIdsEntities.setGroupIds(null);
