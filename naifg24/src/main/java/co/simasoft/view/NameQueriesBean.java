...
import co.simasoft.models.NameQueries;
import co.simasoft.models.Entities;

/**
 * Backing bean for NameQueries entities.
 * <p/>
 * This class provides CRUD functionality for all NameQueries entities. It
...
public class NameQueriesBean implements Serializable {
	...
	/*
	 * Support listing and POSTing back NameQueries entities (e.g. from inside
