...
public class ModelsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Sites sites = deletableEntity.getSites();
			sites.getModels().remove(deletableEntity);
			deletableEntity.setSites(null);
			this.entityManager.merge(sites);
			...
			for (; iterDevelopments.hasNext();) {
				...
				nextInDevelopments.getModels().remove(deletableEntity);
