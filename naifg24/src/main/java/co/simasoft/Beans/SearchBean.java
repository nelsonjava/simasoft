...
public class SearchBean {
    ...
    public List<GroupIdsEntities> selectAllGroupIdsEntities(EntityManager em) {
        prepare(GroupIdsEntities.class,em);

        Query query = qb.all().createQuery();

        List<GroupIdsEntities> results = execute(query,
                                              new Class[]{GroupIdsEntities.class}, null,
                                              new SortField("orden", SortField.DOUBLE));
        return results;
    }
