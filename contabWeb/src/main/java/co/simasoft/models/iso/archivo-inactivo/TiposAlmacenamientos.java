...
@Entity
public class TiposAlmacenamientos {
    ...
    @OneToMany(mappedBy = "tiposAlmacenamientos")
    private Set<Almacenamientos> almacenamientos = new HashSet<Almacenamientos>();

    public TiposAlmacenamientos() {
    }

    public TiposAlmacenamientos(String codigo,String nombre,String descripcion,String link) {
        this.codigo = codigo;
        this.nombre = nombre;
