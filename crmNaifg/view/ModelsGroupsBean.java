...
public class ModelsGroupsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.modelsGroups.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<ModelsGroups> criteria = builder.createQuery(ModelsGroups.class);
                root = criteria.from(ModelsGroups.class);
                TypedQuery<ModelsGroups> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ModelsGroups entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ModelsGroups> getAll() {
                CriteriaQuery<ModelsGroups> criteria = this.entityManager.getCriteriaBuilder().createQuery(ModelsGroups.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ModelsGroups.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ModelsGroupsBean ejbProxy = this.sessionContext.getBusinessObject(ModelsGroupsBean.class);
