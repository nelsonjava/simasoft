...
public class DocumentalsSupportsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.documentalsSupports.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<DocumentalsSupports> root = countCriteria.from(DocumentalsSupports.class);
                ...
                CriteriaQuery<DocumentalsSupports> criteria = builder.createQuery(DocumentalsSupports.class);
                root = criteria.from(DocumentalsSupports.class);
                TypedQuery<DocumentalsSupports> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back DocumentalsSupports entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<DocumentalsSupports> getAll() {
                CriteriaQuery<DocumentalsSupports> criteria = this.entityManager.getCriteriaBuilder().createQuery(DocumentalsSupports.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(DocumentalsSupports.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final DocumentalsSupportsBean ejbProxy = this.sessionContext.getBusinessObject(DocumentalsSupportsBean.class);
