...
public class ImprovementTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.improvementTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<ImprovementTypes> root = countCriteria.from(ImprovementTypes.class);
                ...
                CriteriaQuery<ImprovementTypes> criteria = builder.createQuery(ImprovementTypes.class);
                root = criteria.from(ImprovementTypes.class);
                TypedQuery<ImprovementTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ImprovementTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ImprovementTypes> getAll() {
                CriteriaQuery<ImprovementTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(ImprovementTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ImprovementTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ImprovementTypesBean ejbProxy = this.sessionContext.getBusinessObject(ImprovementTypesBean.class);
