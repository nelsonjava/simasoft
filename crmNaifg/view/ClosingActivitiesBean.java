...
public class ClosingActivitiesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.closingActivities.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<ClosingActivities> root = countCriteria.from(ClosingActivities.class);
                ...
                CriteriaQuery<ClosingActivities> criteria = builder.createQuery(ClosingActivities.class);
                root = criteria.from(ClosingActivities.class);
                TypedQuery<ClosingActivities> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ClosingActivities entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ClosingActivities> getAll() {
                CriteriaQuery<ClosingActivities> criteria = this.entityManager.getCriteriaBuilder().createQuery(ClosingActivities.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ClosingActivities.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ClosingActivitiesBean ejbProxy = this.sessionContext.getBusinessObject(ClosingActivitiesBean.class);
