...
#  ############*..1
#  ModelsGroups Muchos a Uno Unidireccional No.3 GroupIdsTypes
cd ..
cd ModelsGroups.java
...
#  ############
#  ############1..*
#  GroupIdsTypes Uno a Muchos Bidirecccional No.5 ModelsGroups
cd ..
cd GroupIdsTypes.java
jpa-new-field --named modelsGroups --type co.simasoft.models.ModelsGroups --relationshipType One-to-Many;
