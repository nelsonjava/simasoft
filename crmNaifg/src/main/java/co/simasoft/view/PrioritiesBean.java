...
/**
 * Backing bean for Priorities entities.
 * <p/>
 * This class provides CRUD functionality for all Priorities entities. It
...
public class PrioritiesBean implements Serializable {
	...
	public void paginate() {
		...
		CriteriaQuery<Priorities> criteria = builder
				.createQuery(Priorities.class);
		root = criteria.from(Priorities.class);
		TypedQuery<Priorities> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back Priorities entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<Priorities> getAll() {

		CriteriaQuery<Priorities> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(Priorities.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(Priorities.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final PrioritiesBean ejbProxy = this.sessionContext
				.getBusinessObject(PrioritiesBean.class);
