...
public class Attributes implements Serializable {
    ...
    public Attributes(String name,String description,Integer length,Integer precision,Boolean isNullable,Boolean isUnique,Boolean isCreate,Boolean isSearch,Boolean isView,Boolean isViewColumn,Boolean isViewRelation) {
        this.name = name;
