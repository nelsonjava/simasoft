...
public class Fields implements Serializable {
    ...
    public Fields(String name,String description,Integer length,Integer precision,Boolean isNullable,Boolean isUnique,Boolean isCreate,Boolean isSearch,Boolean isView,Boolean isViewColumn,Boolean isViewRelation) {
        this.name = name;
