...
@Entity
@XmlRootElement
public class DocumentalsSupports implements Serializable {
    ...
    public DocumentalsSupports(String name,String code) {
        this.name = name;
        this.code = code;
    }
   ...
   public boolean equals(Object ojt) {
      ...
      DocumentalsSupports other = (DocumentalsSupports) ojt;
      if (id == null) {
         if (other.id != null) {
            return false;
         }
