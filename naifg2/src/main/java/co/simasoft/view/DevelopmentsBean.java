...
import co.simasoft.models.dev.naifg.Developments;
 ...
 * <p/>
 * This class provides CRUD functionality for all Developments entities. It focuses
...
public class DevelopmentsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			for (; iterModels.hasNext();) {
				...
				nextInModels.getDevelopments().remove(deletableEntity);
				iterModels.remove();
	...
	/*
	 * Support listing and POSTing back Developments entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */
