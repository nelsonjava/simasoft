...
public class SystemsModelsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<DomainModels> iterDomainModels = deletableEntity
					.getDomainModels().iterator();
			for (; iterDomainModels.hasNext();) {
				DomainModels nextInDomainModels = iterDomainModels.next();
				nextInDomainModels.setSystemsModels(null);
				iterDomainModels.remove();
				this.entityManager.merge(nextInDomainModels);
			}
