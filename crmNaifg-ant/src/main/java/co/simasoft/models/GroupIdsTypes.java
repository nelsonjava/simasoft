...
@Entity
@XmlRootElement
public class GroupIdsTypes implements Serializable {
	...
	public boolean equals(Object ojt) {
		...
		GroupIdsTypes other = (GroupIdsTypes) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
