...
public class CompaniesRolesTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.companiesRolesTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<CompaniesRoles> iterCompaniesRoles = deletableEntity.getCompaniesRoles().iterator();
          ...
          Iterator<CompaniesRolesTypes> iterObjHijos = deletableEntity.getObjHijos().iterator();
   ...
   1      CompaniesRolesTypes objPadre = deletableEntity.getObjPadre();
   ...
   1      this.entityManager.merge(objPadre);
        ...
        public void paginate() {
                ...
                Root<CompaniesRolesTypes> root = countCriteria.from(CompaniesRolesTypes.class);
                ...
                CriteriaQuery<CompaniesRolesTypes> criteria = builder.createQuery(CompaniesRolesTypes.class);
                root = criteria.from(CompaniesRolesTypes.class);
                TypedQuery<CompaniesRolesTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back CompaniesRolesTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<CompaniesRolesTypes> getAll() {
                CriteriaQuery<CompaniesRolesTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(CompaniesRolesTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(CompaniesRolesTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final CompaniesRolesTypesBean ejbProxy = this.sessionContext.getBusinessObject(CompaniesRolesTypesBean.class);
