...
@Indexed
@Entity
public class GroupIdsFiles implements Serializable {
    ...
    public GroupIdsFiles() {
    }

    public GroupIdsFiles(String name,String type,byte[] data) {
        this.name = name;
        this.type = type;
        this.data = data;
    }
   ...
   public boolean equals(Object ojt) {
      ...
      GroupIdsFiles other = (GroupIdsFiles) ojt;
      if (id == null) {
         if (other.id != null) {
            return false;
         }
