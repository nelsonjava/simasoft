...
public class TypesMeasurementUnitsBean implements Serializable {
        ...
        public void setTypesMeasurementUnits(TypesMeasurementUnits typesMeasurementUnits) {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.typesMeasurementUnits.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<MeasurementUnits> iterMeasurementUnits = deletableEntity.getMeasurementUnits().iterator();
                        for (; iterMeasurementUnits.hasNext();){
                               MeasurementUnits nextInMeasurementUnits = iterMeasurementUnits.next();
        ...
        public void paginate() {
                ...
                Root<TypesMeasurementUnits> root = countCriteria.from(TypesMeasurementUnits.class);
                ...
                CriteriaQuery<TypesMeasurementUnits> criteria = builder.createQuery(TypesMeasurementUnits.class);
                root = criteria.from(TypesMeasurementUnits.class);
                TypedQuery<TypesMeasurementUnits> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back TypesMeasurementUnits entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<TypesMeasurementUnits> getAll() {
                CriteriaQuery<TypesMeasurementUnits> criteria = this.entityManager.getCriteriaBuilder().createQuery(TypesMeasurementUnits.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(TypesMeasurementUnits.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final TypesMeasurementUnitsBean ejbProxy = this.sessionContext.getBusinessObject(TypesMeasurementUnitsBean.class);
