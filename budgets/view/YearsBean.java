...
public class YearsBean implements Serializable {
        ...
        public void paginate() {
                ...
                TypedQuery<Years> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Years entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Years> getAll() {
                CriteriaQuery<Years> criteria = this.entityManager.getCriteriaBuilder().createQuery(Years.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Years.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final YearsBean ejbProxy = this.sessionContext.getBusinessObject(YearsBean.class);
