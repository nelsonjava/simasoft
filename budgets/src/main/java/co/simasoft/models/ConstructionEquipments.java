...
@Entity
@XmlRootElement
public class ConstructionEquipments implements Serializable {
	...
	public ConstructionEquipments() {
	}

	public ConstructionEquipments(String code, String name, Double rate) {
		this.code = code;
		this.name = name;
		this.rate = rate;
	}
	...
	public boolean equals(Object ojt) {
		...
		ConstructionEquipments other = (ConstructionEquipments) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
