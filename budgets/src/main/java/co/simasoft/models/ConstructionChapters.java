...
@Entity
@XmlRootElement
public class ConstructionChapters implements Serializable {
	...
	@OneToMany(mappedBy = "constructionChapters")
	private Set<ConstructionActivities> constructionActivities = new HashSet<ConstructionActivities>();

	public ConstructionChapters() {
	}

	public ConstructionChapters(String code, String name) {
		this.code = code;
		this.name = name;
	}
	...
	public boolean equals(Object ojt) {
		...
		ConstructionChapters other = (ConstructionChapters) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
