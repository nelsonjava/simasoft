...
@Entity
@XmlRootElement
public class ConstructionActivities implements Serializable {
	...
	public ConstructionActivities() {
	}

	public ConstructionActivities(String code, String name) {
		this.code = code;
		this.name = name;
	}
	...
	public boolean equals(Object ojt) {
		...
		ConstructionActivities other = (ConstructionActivities) ojt;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
