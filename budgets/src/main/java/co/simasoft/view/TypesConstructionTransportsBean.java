...
/**
 * Backing bean for TypesConstructionTransports entities.
 * <p/>
 * This class provides CRUD functionality for all TypesConstructionTransports
...
public class TypesConstructionTransportsBean implements Serializable {
	...
	public void setTypesConstructionTransports(
			TypesConstructionTransports typesConstructionTransports) {
		...
		try {
			if (this.id == null) {
				...
				return "view?faces-redirect=true&id="
						+ this.typesConstructionTransports.getId();
			}
		} catch (Exception e) {
		...
		try {
			...
			for (; iterConstructionTransports.hasNext();) {
				ConstructionTransports nextInConstructionTransports = iterConstructionTransports
						.next();
				nextInConstructionTransports
						.setTypesConstructionTransports(null);
	...
	public void paginate() {
		...
		Root<TypesConstructionTransports> root = countCriteria
				.from(TypesConstructionTransports.class);
		...
		CriteriaQuery<TypesConstructionTransports> criteria = builder
				.createQuery(TypesConstructionTransports.class);
		root = criteria.from(TypesConstructionTransports.class);
		TypedQuery<TypesConstructionTransports> query = this.entityManager
	...
	private Predicate[] getSearchPredicates(
			Root<TypesConstructionTransports> root) {
	...
	/*
	 * Support listing and POSTing back TypesConstructionTransports entities
	 * (e.g. from inside an HtmlSelectOneMenu)
	 */

	public List<TypesConstructionTransports> getAll() {

		CriteriaQuery<TypesConstructionTransports> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(
						TypesConstructionTransports.class);
	...
	public Converter getConverter() {
		...
		final TypesConstructionTransportsBean ejbProxy = this.sessionContext
				.getBusinessObject(TypesConstructionTransportsBean.class);
		...
		return new Converter() {
			...
			public String getAsString(FacesContext context,
				...
				return String.valueOf(((TypesConstructionTransports) value)
						.getId());
			}
		};
	}
