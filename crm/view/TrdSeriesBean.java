...
public class TrdSeriesBean implements Serializable {
        ...
        public void paginate() {
                ...
                CriteriaQuery<TrdSeries> criteria = builder.createQuery(TrdSeries.class);
                root = criteria.from(TrdSeries.class);
                TypedQuery<TrdSeries> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back TrdSeries entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<TrdSeries> getAll() {
                CriteriaQuery<TrdSeries> criteria = this.entityManager.getCriteriaBuilder().createQuery(TrdSeries.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(TrdSeries.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final TrdSeriesBean ejbProxy = this.sessionContext.getBusinessObject(TrdSeriesBean.class);
