...
public class ContinualImprovementsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.continualImprovements.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<ActionPlans> iterActionPlans = deletableEntity.getActionPlans().iterator();
                        ...
                        ImprovementClosures improvementClosures = deletableEntity.getImprovementClosures();
                        improvementClosures.getContinualImprovements().remove(deletableEntity);
                        deletableEntity.setImprovementClosures(null);
                        this.entityManager.merge(improvementClosures);
                        ImprovementTypes improvementTypes = deletableEntity.getImprovementTypes();
                        ...
                        ImprovementSources improvementSources = deletableEntity.getImprovementSources();
                        improvementSources.getContinualImprovements().remove(deletableEntity);
                        deletableEntity.setImprovementSources(null);
                        this.entityManager.merge(improvementSources);
                        ImprovementVerifications improvementVerifications = deletableEntity.getImprovementVerifications();
                        improvementVerifications.getContinualImprovements().remove(deletableEntity);
        ...
        public void paginate() {
                ...
                Root<ContinualImprovements> root = countCriteria.from(ContinualImprovements.class);
                ...
                CriteriaQuery<ContinualImprovements> criteria = builder.createQuery(ContinualImprovements.class);
                root = criteria.from(ContinualImprovements.class);
                TypedQuery<ContinualImprovements> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ContinualImprovements entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ContinualImprovements> getAll() {
                CriteriaQuery<ContinualImprovements> criteria = this.entityManager.getCriteriaBuilder().createQuery(ContinualImprovements.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ContinualImprovements.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ContinualImprovementsBean ejbProxy = this.sessionContext.getBusinessObject(ContinualImprovementsBean.class);
