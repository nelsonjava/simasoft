...
public class ConservationUnitsTypesBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.conservationUnitsTypes.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<ConservationUnits> iterConservationUnits = deletableEntity.getConservationUnits().iterator();
                        for (; iterConservationUnits.hasNext();){
                               ConservationUnits nextInConservationUnits = iterConservationUnits.next();
        ...
        public void paginate() {
                ...
                Root<ConservationUnitsTypes> root = countCriteria.from(ConservationUnitsTypes.class);
                ...
                CriteriaQuery<ConservationUnitsTypes> criteria = builder.createQuery(ConservationUnitsTypes.class);
                root = criteria.from(ConservationUnitsTypes.class);
                TypedQuery<ConservationUnitsTypes> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ConservationUnitsTypes entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ConservationUnitsTypes> getAll() {
                CriteriaQuery<ConservationUnitsTypes> criteria = this.entityManager.getCriteriaBuilder().createQuery(ConservationUnitsTypes.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ConservationUnitsTypes.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ConservationUnitsTypesBean ejbProxy = this.sessionContext.getBusinessObject(ConservationUnitsTypesBean.class);
