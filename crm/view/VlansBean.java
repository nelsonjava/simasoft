...
public class VlansBean implements Serializable {
        ...
        public void paginate() {
                ...
                TypedQuery<Vlans> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Vlans entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Vlans> getAll() {
                CriteriaQuery<Vlans> criteria = this.entityManager.getCriteriaBuilder().createQuery(Vlans.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Vlans.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final VlansBean ejbProxy = this.sessionContext.getBusinessObject(VlansBean.class);
