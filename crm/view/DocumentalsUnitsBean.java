...
public class DocumentalsUnitsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.documentalsUnits.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
          ...
          Iterator<DocumentalsUnits> iterObjHijos = deletableEntity.getObjHijos().iterator();
          for (; iterObjHijos.hasNext();){
             ...
             this.entityManager.merge(nextInObjHijos);
               ...
               this.entityManager.merge(proteccion);
                        ...
                        FrequentlyQuery frequentlyQuery = deletableEntity.getFrequentlyQuery();
                        ...
                        DocumentalsUnitsTypes documentalsUnitsTypes = deletableEntity.getDocumentalsUnitsTypes();
   ...
   1      DocumentalsUnits objPadre = deletableEntity.getObjPadre();
   ...
   1      this.entityManager.merge(objPadre);
        ...
        public void paginate() {
                ...
                Root<DocumentalsUnits> root = countCriteria.from(DocumentalsUnits.class);
                ...
                CriteriaQuery<DocumentalsUnits> criteria = builder.createQuery(DocumentalsUnits.class);
                root = criteria.from(DocumentalsUnits.class);
                TypedQuery<DocumentalsUnits> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back DocumentalsUnits entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<DocumentalsUnits> getAll() {
                CriteriaQuery<DocumentalsUnits> criteria = this.entityManager.getCriteriaBuilder().createQuery(DocumentalsUnits.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(DocumentalsUnits.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final DocumentalsUnitsBean ejbProxy = this.sessionContext.getBusinessObject(DocumentalsUnitsBean.class);
