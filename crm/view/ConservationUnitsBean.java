...
public class ConservationUnitsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.conservationUnits.getId();
                        }
                } catch (Exception e) {
        ...
        public String delete() {
                ...
                try {
                        ...
                        conservationUnitsTypes.getConservationUnits().remove(deletableEntity);
        ...
        public void paginate() {
                ...
                Root<ConservationUnits> root = countCriteria.from(ConservationUnits.class);
                ...
                CriteriaQuery<ConservationUnits> criteria = builder.createQuery(ConservationUnits.class);
                root = criteria.from(ConservationUnits.class);
                TypedQuery<ConservationUnits> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ConservationUnits entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ConservationUnits> getAll() {
                CriteriaQuery<ConservationUnits> criteria = this.entityManager.getCriteriaBuilder().createQuery(ConservationUnits.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ConservationUnits.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ConservationUnitsBean ejbProxy = this.sessionContext.getBusinessObject(ConservationUnitsBean.class);
