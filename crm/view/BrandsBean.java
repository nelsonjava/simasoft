...
public class BrandsBean implements Serializable {
        ...
        public void paginate() {
                ...
                TypedQuery<Brands> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Brands entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Brands> getAll() {
                CriteriaQuery<Brands> criteria = this.entityManager.getCriteriaBuilder().createQuery(Brands.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Brands.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final BrandsBean ejbProxy = this.sessionContext.getBusinessObject(BrandsBean.class);
