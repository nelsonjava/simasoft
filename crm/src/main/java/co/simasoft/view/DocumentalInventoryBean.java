 ...
 * <p/>
 * This class provides CRUD functionality for all DocumentalInventory entities.
...
public class DocumentalInventoryBean implements Serializable {
		...
		try {
			if (this.id == null) {
				...
				return "view?faces-redirect=true&id="
						+ this.documentalInventory.getId();
			}
		} catch (Exception e) {
	...
	public void paginate() {
		...
		Root<DocumentalInventory> root = countCriteria
				.from(DocumentalInventory.class);
		...
		CriteriaQuery<DocumentalInventory> criteria = builder
				.createQuery(DocumentalInventory.class);
		root = criteria.from(DocumentalInventory.class);
		TypedQuery<DocumentalInventory> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back DocumentalInventory entities (e.g. from
	 * inside an HtmlSelectOneMenu)
	 */

	public List<DocumentalInventory> getAll() {

		CriteriaQuery<DocumentalInventory> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(DocumentalInventory.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(DocumentalInventory.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final DocumentalInventoryBean ejbProxy = this.sessionContext
				.getBusinessObject(DocumentalInventoryBean.class);
