...
/**
 * Backing bean for HostsTypes entities.
 * <p/>
 * This class provides CRUD functionality for all HostsTypes entities. It
...
public class HostsTypesBean implements Serializable {
	...
	public void paginate() {
		...
		CriteriaQuery<HostsTypes> criteria = builder
				.createQuery(HostsTypes.class);
		root = criteria.from(HostsTypes.class);
		TypedQuery<HostsTypes> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back HostsTypes entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<HostsTypes> getAll() {

		CriteriaQuery<HostsTypes> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(HostsTypes.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(HostsTypes.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final HostsTypesBean ejbProxy = this.sessionContext
				.getBusinessObject(HostsTypesBean.class);
