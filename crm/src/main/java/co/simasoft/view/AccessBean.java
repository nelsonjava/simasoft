...
/**
 * Backing bean for Access entities.
 * <p/>
 * This class provides CRUD functionality for all Access entities. It focuses
...
public class AccessBean implements Serializable {
	...
	public void paginate() {
		...
		TypedQuery<Access> query = this.entityManager.createQuery(criteria
	...
	/*
	 * Support listing and POSTing back Access entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */

	public List<Access> getAll() {

		CriteriaQuery<Access> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(Access.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(Access.class))).getResultList();
	}
	...
	public Converter getConverter() {
		...
		final AccessBean ejbProxy = this.sessionContext
				.getBusinessObject(AccessBean.class);
