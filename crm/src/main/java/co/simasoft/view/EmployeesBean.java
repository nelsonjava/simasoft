...
public class EmployeesBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			physicalAreas.getEmployees().remove(deletableEntity);
	...
	private Predicate[] getSearchPredicates(Root<Employees> root) {
		...
		PhysicalAreas physicalAreas = this.example.getPhysicalAreas();
		if (physicalAreas != null) {
			predicatesList.add(builder.equal(root.get("physicalAreas"),
					physicalAreas));
		}
