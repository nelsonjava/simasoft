...
/**
 * Backing bean for ImprovementSources entities.
 * <p/>
 * This class provides CRUD functionality for all ImprovementSources entities.
...
public class ImprovementSourcesBean implements Serializable {
	...
	public void paginate() {
		...
		Root<ImprovementSources> root = countCriteria
				.from(ImprovementSources.class);
		...
		CriteriaQuery<ImprovementSources> criteria = builder
				.createQuery(ImprovementSources.class);
		root = criteria.from(ImprovementSources.class);
		TypedQuery<ImprovementSources> query = this.entityManager
	...
	/*
	 * Support listing and POSTing back ImprovementSources entities (e.g. from
	 * inside an HtmlSelectOneMenu)
	 */

	public List<ImprovementSources> getAll() {

		CriteriaQuery<ImprovementSources> criteria = this.entityManager
				.getCriteriaBuilder().createQuery(ImprovementSources.class);
		return this.entityManager.createQuery(
				criteria.select(criteria.from(ImprovementSources.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final ImprovementSourcesBean ejbProxy = this.sessionContext
				.getBusinessObject(ImprovementSourcesBean.class);
