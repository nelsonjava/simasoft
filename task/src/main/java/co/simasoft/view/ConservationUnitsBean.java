 ...
 * <p/>
 * This class provides CRUD functionality for all ConservationUnits entities. It focuses
...
public class ConservationUnitsBean implements Serializable {
	...
	/*
	 * Support listing and POSTing back ConservationUnits entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */
