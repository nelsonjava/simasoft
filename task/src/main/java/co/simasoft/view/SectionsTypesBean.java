 ...
 * <p/>
 * This class provides CRUD functionality for all SectionsTypes entities. It focuses
...
public class SectionsTypesBean implements Serializable {
	...
	/*
	 * Support listing and POSTing back SectionsTypes entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */
