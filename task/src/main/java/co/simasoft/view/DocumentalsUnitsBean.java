 ...
 * <p/>
 * This class provides CRUD functionality for all DocumentalsUnits entities. It focuses
...
public class DocumentalsUnitsBean implements Serializable {
	...
	/*
	 * Support listing and POSTing back DocumentalsUnits entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */
