...
public class PersonsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			PersonalType personalType = deletableEntity.getPersonalType();
			personalType.getPersons().remove(deletableEntity);
			deletableEntity.setPersonalType(null);
			this.entityManager.merge(personalType);
