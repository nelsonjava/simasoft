 ...
 * <p/>
 * This class provides CRUD functionality for all DocumentsTypes entities. It focuses
...
public class DocumentsTypesBean implements Serializable {
	...
	/*
	 * Support listing and POSTing back DocumentsTypes entities (e.g. from inside an
	 * HtmlSelectOneMenu)
	 */
