...
public class Relationships implements Serializable {
	...
	public Relationships(String description, String entity,
			String observaciones, String annotationsMethod, String mappedby,
			String name, Boolean optionality, String idTabla2, String idTabla1,
			String tabla, String annotationsField) {
