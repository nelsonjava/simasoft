...
public class DomainModelsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			for (; iterFilesModels.hasNext();) {
				...
				nextInFilesModels.setDomainModels(null);
	...
	public void paginate() {
		...
		CriteriaQuery<DomainModels> criteria = builder
				.createQuery(DomainModels.class);
		root = criteria.from(DomainModels.class);
		TypedQuery<DomainModels> query = this.entityManager
	...
	public List<DomainModels> getAll() {
		...
		return this.entityManager.createQuery(
				criteria.select(criteria.from(DomainModels.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final DomainModelsBean ejbProxy = this.sessionContext
				.getBusinessObject(DomainModelsBean.class);
