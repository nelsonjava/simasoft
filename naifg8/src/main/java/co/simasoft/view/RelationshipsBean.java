...
public class RelationshipsBean implements Serializable {
	...
	private Predicate[] getSearchPredicates(Root<Relationships> root) {
		...
		String idTable2 = this.example.getIdTable2();
		if (idTable2 != null && !"".equals(idTable2)) {
			predicatesList.add(builder.like(
					builder.lower(root.<String> get("idTable2")),
					'%' + idTable2.toLowerCase() + '%'));
		}
		...
		String idTable1 = this.example.getIdTable1();
		if (idTable1 != null && !"".equals(idTable1)) {
			predicatesList.add(builder.like(
					builder.lower(root.<String> get("idTable1")),
					'%' + idTable1.toLowerCase() + '%'));
		}
