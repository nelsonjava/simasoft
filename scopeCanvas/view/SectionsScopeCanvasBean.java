...
public class SectionsScopeCanvasBean implements Serializable{
        ...
        */
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.sectionsScopeCanvas.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<SectionsScopeCanvas> root = countCriteria.from(SectionsScopeCanvas.class);
                ...
                CriteriaQuery<SectionsScopeCanvas> criteria = builder.createQuery(SectionsScopeCanvas.class);
                root = criteria.from(SectionsScopeCanvas.class);
                TypedQuery<SectionsScopeCanvas> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back SectionsScopeCanvas entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<SectionsScopeCanvas> getAll() {
                CriteriaQuery<SectionsScopeCanvas> criteria = this.entityManager.getCriteriaBuilder().createQuery(SectionsScopeCanvas.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(SectionsScopeCanvas.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final SectionsScopeCanvasBean ejbProxy = this.sessionContext.getBusinessObject(SectionsScopeCanvasBean.class);
