...
public class VideosBean implements Serializable {
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<VideoContents> iterVideoContents = deletableEntity.getVideoContents().iterator();
        ...
        public void paginate() {
                ...
                TypedQuery<Videos> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Videos entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Videos> getAll() {
                CriteriaQuery<Videos> criteria = this.entityManager.getCriteriaBuilder().createQuery(Videos.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Videos.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final VideosBean ejbProxy = this.sessionContext.getBusinessObject(VideosBean.class);
