...
public class TypesFilmsBean implements Serializable {
        ...
        public void paginate() {
                ...
                CriteriaQuery<TypesFilms> criteria = builder.createQuery(TypesFilms.class);
                root = criteria.from(TypesFilms.class);
                TypedQuery<TypesFilms> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back TypesFilms entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<TypesFilms> getAll() {
                CriteriaQuery<TypesFilms> criteria = this.entityManager.getCriteriaBuilder().createQuery(TypesFilms.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(TypesFilms.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final TypesFilmsBean ejbProxy = this.sessionContext.getBusinessObject(TypesFilmsBean.class);
