...
public class VideoContentsBean implements Serializable {
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.videoContents.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<VideoContents> criteria = builder.createQuery(VideoContents.class);
                root = criteria.from(VideoContents.class);
                TypedQuery<VideoContents> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back VideoContents entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<VideoContents> getAll() {
                CriteriaQuery<VideoContents> criteria = this.entityManager.getCriteriaBuilder().createQuery(VideoContents.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(VideoContents.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final VideoContentsBean ejbProxy = this.sessionContext.getBusinessObject(VideoContentsBean.class);
