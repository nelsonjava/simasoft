 ...
 * <p/>
 * This class provides CRUD functionality for all AttributesProperties entities.
...
public class AttributesPropertiesBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			for (; iterSites.hasNext();) {
				...
				nextInSites.getAttributesProperties().remove(deletableEntity);
				iterSites.remove();
			...
			for (; iterCardinalities.hasNext();) {
				...
				nextInCardinalities.getAttributesProperties().remove(
						deletableEntity);
			...
			for (; iterRelationships.hasNext();) {
				...
				nextInRelationships.getAttributesProperties().remove(
						deletableEntity);
	...
	/*
	 * Support listing and POSTing back AttributesProperties entities (e.g. from
