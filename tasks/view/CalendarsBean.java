...
public class CalendarsBean implements Serializable{
        ...
        */
        ...
        public void paginate() {
                ...
                CriteriaQuery<Calendars> criteria = builder.createQuery(Calendars.class);
                root = criteria.from(Calendars.class);
                TypedQuery<Calendars> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back Calendars entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<Calendars> getAll() {
                CriteriaQuery<Calendars> criteria = this.entityManager.getCriteriaBuilder().createQuery(Calendars.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(Calendars.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final CalendarsBean ejbProxy = this.sessionContext.getBusinessObject(CalendarsBean.class);
