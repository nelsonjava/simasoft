...
public class TiposLinksModelsBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.tiposLinksModels.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         Iterator<LinksModels> iterLinksModels = deletableEntity.getLinksModels().iterator();
   ...
   public void paginate()
   {
      ...
      Root<TiposLinksModels> root = countCriteria.from(TiposLinksModels.class);
      ...
      CriteriaQuery<TiposLinksModels> criteria = builder.createQuery(TiposLinksModels.class);
      root = criteria.from(TiposLinksModels.class);
      TypedQuery<TiposLinksModels> query = this.entityManager.createQuery(criteria
   ...
   public List<TiposLinksModels> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(TiposLinksModels.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      final TiposLinksModelsBean ejbProxy = this.sessionContext.getBusinessObject(TiposLinksModelsBean.class);
