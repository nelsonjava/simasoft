...
public class FilesModelsBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.filesModels.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public void paginate()
   {
      ...
      CriteriaQuery<FilesModels> criteria = builder.createQuery(FilesModels.class);
   ...
   private Predicate[] getSearchPredicates(Root<FilesModels> root)
   {
      ...
      {
         predicatesList.add(builder.like(builder.lower(root.<String> get("extension")), '%' + extension.toLowerCase() + '%'));
      }
   ...
   public List<FilesModels> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(FilesModels.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      final FilesModelsBean ejbProxy = this.sessionContext.getBusinessObject(FilesModelsBean.class);
