...
public class SystemsModelsBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.systemsModels.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public void paginate()
   {
      ...
      CriteriaQuery<SystemsModels> criteria = builder.createQuery(SystemsModels.class);
      root = criteria.from(SystemsModels.class);
      TypedQuery<SystemsModels> query = this.entityManager.createQuery(criteria
   ...
   public List<SystemsModels> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(SystemsModels.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      final SystemsModelsBean ejbProxy = this.sessionContext.getBusinessObject(SystemsModelsBean.class);
