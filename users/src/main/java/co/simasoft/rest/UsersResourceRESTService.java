...
import co.simasoft.data.UsersRepository;
import co.simasoft.models.dev.users.Users;
import co.simasoft.service.UsersRegistration;
...
public class UsersResourceRESTService {
    ...
    @Path("/{id:[0-9][0-9]*}")
    @Produces(MediaType.APPLICATION_JSON)
    public Users lookupUsersById(@PathParam("id") long id) {
     ...
     */
    private void validateUsers(Users users) throws ConstraintViolationException, ValidationException {
        ...
        if (emailAlreadyExists(users.getEmail())) {
