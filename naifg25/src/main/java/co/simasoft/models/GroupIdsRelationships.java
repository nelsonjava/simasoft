...
@Entity
@XmlRootElement
public class GroupIdsRelationships implements Serializable {
    ...
    public GroupIdsRelationships() {
    }

    public GroupIdsRelationships(Boolean isIsolated,Boolean isSimplified) {
   ...
   public boolean equals(Object ojt) {
      ...
      GroupIdsRelationships other = (GroupIdsRelationships) ojt;
      if (id == null) {
         if (other.id != null) {
            return false;
         }
