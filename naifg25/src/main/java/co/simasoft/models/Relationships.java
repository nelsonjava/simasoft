...
public class Relationships implements Serializable {
    ...
    public Relationships(Boolean isCreate,Boolean isSearch,Boolean isView,String name,Boolean isOptionality,Boolean isEmbedded,Boolean isSimplified) {
    ...
    public void setGroupIdsRelationships(Set<GroupIdsRelationships> groupIdsRelationships) {
