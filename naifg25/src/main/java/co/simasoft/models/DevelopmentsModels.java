...
@Entity
@XmlRootElement
public class DevelopmentsModels implements Serializable {
    ...
    public DevelopmentsModels(String code,String name) {
        this.code = code;
        this.name = name;
    }
   ...
   public boolean equals(Object ojt) {
      ...
      DevelopmentsModels other = (DevelopmentsModels) ojt;
      if (id == null) {
         if (other.id != null) {
            return false;
         }
