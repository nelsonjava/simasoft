...
import co.simasoft.models.ModelsGroupIds;
...
public class GroupIdsBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Iterator<GroupIdsRelationships> iterGroupIdsRelationships = deletableEntity
					.getGroupIdsRelationships().iterator();
			for (; iterGroupIdsRelationships.hasNext();) {
				GroupIdsRelationships nextInGroupIdsRelationships = iterGroupIdsRelationships
						.next();
				nextInGroupIdsRelationships.setGroupIds(null);
				iterGroupIdsRelationships.remove();
				this.entityManager.merge(nextInGroupIdsRelationships);
			}
