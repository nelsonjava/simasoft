...
public class GroupIdsRelationshipsBean implements Serializable{
        ...
        public void setGroupIdsRelationships(GroupIdsRelationships groupIdsRelationships) {
        ...
        */
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.groupIdsRelationships.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                Root<GroupIdsRelationships> root = countCriteria.from(GroupIdsRelationships.class);
                ...
                CriteriaQuery<GroupIdsRelationships> criteria = builder.createQuery(GroupIdsRelationships.class);
                root = criteria.from(GroupIdsRelationships.class);
                TypedQuery<GroupIdsRelationships> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back GroupIdsRelationships entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<GroupIdsRelationships> getAll() {
                CriteriaQuery<GroupIdsRelationships> criteria = this.entityManager.getCriteriaBuilder().createQuery(GroupIdsRelationships.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(GroupIdsRelationships.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final GroupIdsRelationshipsBean ejbProxy = this.sessionContext.getBusinessObject(GroupIdsRelationshipsBean.class);
