        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        Iterator<GroupIdsRelationships> iterGroupIdsRelationships = deletableEntity.getGroupIdsRelationships().iterator();
                        for (; iterGroupIdsRelationships.hasNext();){
                               GroupIdsRelationships nextInGroupIdsRelationships = iterGroupIdsRelationships.next();
                                nextInGroupIdsRelationships.setRelationships(null);
