        ...
        */
        ...
        public String delete() {
                ...
                try {
                        ...
                        dependencies.getSites().remove(deletableEntity);
                        deletableEntity.setDependencies(null);
                        this.entityManager.merge(dependencies);
                        Imports imports = deletableEntity.getImports();
                        imports.getSites().remove(deletableEntity);
                        deletableEntity.setImports(null);
                        this.entityManager.merge(imports);
                        AttributesProperties attributesProperties = deletableEntity.getAttributesProperties();
                        attributesProperties.getSites().remove(deletableEntity);
                        ...
                        cardinalities.getSites().remove(deletableEntity);
