...
public class ModelsGroupIdsBean implements Serializable{
        ...
        */
        ...
        public String update() {
                ...
                try {
                        if (this.id == null) {
                                ...
                                return "view?faces-redirect=true&id=" + this.modelsGroupIds.getId();
                        }
                } catch (Exception e) {
        ...
        public void paginate() {
                ...
                CriteriaQuery<ModelsGroupIds> criteria = builder.createQuery(ModelsGroupIds.class);
                root = criteria.from(ModelsGroupIds.class);
                TypedQuery<ModelsGroupIds> query = this.entityManager.createQuery(criteria.select(root).where(getSearchPredicates(root)));
        ...
        /*
         * Support listing and POSTing back ModelsGroupIds entities (e.g. from inside an HtmlSelectOneMenu)
         */

        public List<ModelsGroupIds> getAll() {
                CriteriaQuery<ModelsGroupIds> criteria = this.entityManager.getCriteriaBuilder().createQuery(ModelsGroupIds.class);
                return this.entityManager.createQuery(criteria.select(criteria.from(ModelsGroupIds.class))).getResultList();
        }
        ...
        public Converter getConverter() {
                ...
                final ModelsGroupIdsBean ejbProxy = this.sessionContext.getBusinessObject(ModelsGroupIdsBean.class);
